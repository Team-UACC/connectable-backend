...
public class TicketFixture {
    ...
    private static final String TOKEN_URI_FORMAT =
            "https://connectable-events.s3.ap-northeast-2.amazonaws.com/json/%d.json";
    private static final String IMAGE_URI_FORMAT =
            "https://connectable-events.s3.ap-northeast-2.amazonaws.com/ticket_test%d.png";
